...
namespace SocialSiteWithoutMVC.DataAccessLayer.Migrations
{
    ...
    [Migration("20250822135729_WithNullChats")]
    partial class WithNullChats
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataAccessLayer.Models.ChatEntity", b =>
                {
            ...
            modelBuilder.Entity("DataAccessLayer.Models.MessageEntity", b =>
                {
            ...
            modelBuilder.Entity("ChatEntityUserEntity", b =>
                {
                    b.HasOne("DataAccessLayer.Models.ChatEntity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("DataAccessLayer.Models.MessageEntity", b =>
                {
                    b.HasOne("DataAccessLayer.Models.ChatEntity", "Chat")
                        .WithMany("Messages")
